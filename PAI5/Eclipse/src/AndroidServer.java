			...
			try {
				...
				if (usuarios.containsKey(usuario)) {
					...
					if (sg.verify(base64Decode(firmaMensaje))) {
						...
						//Por cada pedido, se a�ade uno a la base de datos
						for (int i=0; productos.length > i; i++){
							//Se obtiene el producto y cantidad de �ste en parts
...
//						database.setPedido(p);
						...
						os.writeChars("Petici�n OK");
					} else {
						System.out.println("Error de firma");
						os.writeChars("Petici�n incorrecta");
					}
				} else {
